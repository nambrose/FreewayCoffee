...
public class FreewayCoffeeHTTPClient extends DefaultHttpClient  implements org.apache.http.conn.ssl.X509HostnameVerifier
{
	final Context context;
	private SSLSocketFactory sf;
	
    public FreewayCoffeeHTTPClient(Context context) 
    {
        this.context = context;
    }
    
    public FreewayCoffeeHTTPClient(Context context,HttpParams httpParameters )
    {
	...
	{
		if(host.equals(FreewayCoffeeApp.HOST_NAME))
		{
