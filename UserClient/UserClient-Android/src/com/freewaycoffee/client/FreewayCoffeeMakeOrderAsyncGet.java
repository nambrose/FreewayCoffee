...
public class FreewayCoffeeMakeOrderAsyncGet extends AsyncTask<String,Integer,String> 
{
	/*
	...
	public FreewayCoffeeMakeOrderAsyncGet(FreewayCoffeeItemListView activity, FreewayCoffeeApp app)
	{
		Completed=false;
		myActivity = activity;
		myApp = app;
	...
	{
		Completed=false;
		myActivity.showMakeOrderProgressDialog();
	}
