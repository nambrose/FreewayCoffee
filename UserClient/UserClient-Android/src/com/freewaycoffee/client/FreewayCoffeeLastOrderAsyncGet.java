...
public class FreewayCoffeeLastOrderAsyncGet extends AsyncTask<String,Integer,String> 
{
	/*
	...
	private FreewayCoffeeOrderResultActivity myActivity;
	...
	public FreewayCoffeeLastOrderAsyncGet(FreewayCoffeeOrderResultActivity activity, FreewayCoffeeApp app)
	{
		//Completed=false;
		myActivity = activity;
		myApp = app;
	...
	{
		Completed=false;
		myActivity.showArrivedProgressDialog();
	}
	...
	public void SetActivity(FreewayCoffeeOrderResultActivity activity)
	{
		myActivity = activity;
